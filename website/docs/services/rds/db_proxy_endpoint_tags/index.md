...
For permissions required to operate on the <code>db_proxy_endpoint_tags</code> resource, see <a href="/services/rds/db_proxy_endpoints/#permissions"><code>db_proxy_endpoints</code></a>
