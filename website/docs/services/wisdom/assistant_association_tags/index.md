...
Expands all tag keys and values for <code>assistant_associations</code> in a region
...
## `SELECT` examples
Expands tags for all <code>assistant_associations</code> in a region.
```sql
SELECT
region,
...
For permissions required to operate on the <code>assistant_association_tags</code> resource, see <a href="/services/wisdom/assistant_associations/#permissions"><code>assistant_associations</code></a>
