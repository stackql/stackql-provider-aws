...
Expands all tag keys and values for <code>configured_table_associations</code> in a region
...
## `SELECT` examples
Expands tags for all <code>configured_table_associations</code> in a region.
```sql
SELECT
region,
arn,
...
For permissions required to operate on the <code>configured_table_association_tags</code> resource, see <a href="/services/cleanrooms/configured_table_associations/#permissions"><code>configured_table_associations</code></a>
