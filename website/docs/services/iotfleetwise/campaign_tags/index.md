...
For permissions required to operate on the <code>campaign_tags</code> resource, see <a href="/services/iotfleetwise/campaigns/#permissions"><code>campaigns</code></a>
