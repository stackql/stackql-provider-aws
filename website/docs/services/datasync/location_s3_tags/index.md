...
For permissions required to operate on the <code>location_s3_tags</code> resource, see <a href="/services/datasync/location_s3s/#permissions"><code>location_s3s</code></a>
