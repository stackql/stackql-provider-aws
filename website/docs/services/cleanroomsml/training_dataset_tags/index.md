...
Expands all tag keys and values for <code>training_datasets</code> in a region
...
## `SELECT` examples
Expands tags for all <code>training_datasets</code> in a region.
```sql
SELECT
region,
description,
...
For permissions required to operate on the <code>training_dataset_tags</code> resource, see <a href="/services/cleanroomsml/training_datasets/#permissions"><code>training_datasets</code></a>
