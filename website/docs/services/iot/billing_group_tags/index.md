...
tag_key,
tag_value
FROM aws.iot.billing_group_tags
...
For permissions required to operate on the <code>billing_group_tags</code> resource, see <a href="/services/iot/billing_groups/#permissions"><code>billing_groups</code></a>
