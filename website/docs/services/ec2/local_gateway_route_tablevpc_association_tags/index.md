...
Expands all tag keys and values for <code>local_gateway_route_tablevpc_associations</code> in a region
...
## `SELECT` examples
Expands tags for all <code>local_gateway_route_tablevpc_associations</code> in a region.
```sql
SELECT
region,
local_gateway_id,
...
For permissions required to operate on the <code>local_gateway_route_tablevpc_association_tags</code> resource, see <a href="/services/ec2/local_gateway_route_tablevpc_associations/#permissions"><code>local_gateway_route_tablevpc_associations</code></a>
