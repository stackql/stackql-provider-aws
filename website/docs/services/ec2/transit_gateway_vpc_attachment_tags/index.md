...
Expands all tag keys and values for <code>transit_gateway_vpc_attachments</code> in a region
...
## `SELECT` examples
Expands tags for all <code>transit_gateway_vpc_attachments</code> in a region.
```sql
SELECT
region,
id,
...
For permissions required to operate on the <code>transit_gateway_vpc_attachment_tags</code> resource, see <a href="/services/ec2/transit_gateway_vpc_attachments/#permissions"><code>transit_gateway_vpc_attachments</code></a>
