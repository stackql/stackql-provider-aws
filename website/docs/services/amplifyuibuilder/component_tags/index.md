...
For permissions required to operate on the <code>component_tags</code> resource, see <a href="/services/amplifyuibuilder/components/#permissions"><code>components</code></a>
