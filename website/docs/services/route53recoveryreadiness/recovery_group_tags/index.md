...
Expands all tag keys and values for <code>recovery_groups</code> in a region
...
## `SELECT` examples
Expands tags for all <code>recovery_groups</code> in a region.
```sql
SELECT
region,
recovery_group_name,
...
For permissions required to operate on the <code>recovery_group_tags</code> resource, see <a href="/services/route53recoveryreadiness/recovery_groups/#permissions"><code>recovery_groups</code></a>
