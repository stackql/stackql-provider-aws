...
Expands all tag keys and values for <code>partnerships</code> in a region
...
## `SELECT` examples
Expands tags for all <code>partnerships</code> in a region.
```sql
SELECT
region,
capabilities,
...
For permissions required to operate on the <code>partnership_tags</code> resource, see <a href="/services/b2bi/partnerships/#permissions"><code>partnerships</code></a>
