...
For permissions required to operate on the <code>replication_config_tags</code> resource, see <a href="/services/dms/replication_configs/#permissions"><code>replication_configs</code></a>
