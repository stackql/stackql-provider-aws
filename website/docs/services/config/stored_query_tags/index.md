...
Expands all tag keys and values for <code>stored_queries</code> in a region
...
## `SELECT` examples
Expands tags for all <code>stored_queries</code> in a region.
```sql
SELECT
region,
query_arn,
...
For permissions required to operate on the <code>stored_query_tags</code> resource, see <a href="/services/config/stored_queries/#permissions"><code>stored_queries</code></a>
