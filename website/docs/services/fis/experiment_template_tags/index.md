...
For permissions required to operate on the <code>experiment_template_tags</code> resource, see <a href="/services/fis/experiment_templates/#permissions"><code>experiment_templates</code></a>
