...
Expands all tag keys and values for <code>in_app_templates</code> in a region
...
## `SELECT` examples
Expands tags for all <code>in_app_templates</code> in a region.
```sql
SELECT
region,
arn,
...
For permissions required to operate on the <code>in_app_template_tags</code> resource, see <a href="/services/pinpoint/in_app_templates/#permissions"><code>in_app_templates</code></a>
