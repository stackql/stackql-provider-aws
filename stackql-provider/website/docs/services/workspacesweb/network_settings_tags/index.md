...
Expands all tag keys and values for <code>network_settings</code> in a region
...
## `SELECT` examples
Expands tags for all <code>network_settings</code> in a region.
```sql
SELECT
region,
...
tag_key,
tag_value
FROM aws.workspacesweb.network_settings_tags
...
For permissions required to operate on the <code>network_settings_tags</code> resource, see <a href="/services/workspacesweb/network_settings/#permissions"><code>network_settings</code></a>
