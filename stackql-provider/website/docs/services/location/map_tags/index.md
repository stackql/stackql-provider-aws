...
Expands all tag keys and values for <code>maps</code> in a region
...
## `SELECT` examples
Expands tags for all <code>maps</code> in a region.
```sql
SELECT
region,
configuration,
...
For permissions required to operate on the <code>map_tags</code> resource, see <a href="/services/location/maps/#permissions"><code>maps</code></a>
