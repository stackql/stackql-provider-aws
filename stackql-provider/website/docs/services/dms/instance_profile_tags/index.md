...
For permissions required to operate on the <code>instance_profile_tags</code> resource, see <a href="/services/dms/instance_profiles/#permissions"><code>instance_profiles</code></a>
