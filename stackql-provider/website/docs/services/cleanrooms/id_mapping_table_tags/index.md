...
Expands all tag keys and values for <code>id_mapping_tables</code> in a region

## Overview
<table>
<tbody>
<tr><td><b>Name</b></td><td><code>id_mapping_table_tags</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Description</b></td><td>Represents an association between an ID mapping workflow and a collaboration</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.cleanrooms.id_mapping_table_tags" /></td></tr>
</tbody>
</table>
...
## `SELECT` examples
Expands tags for all <code>id_mapping_tables</code> in a region.
```sql
SELECT
region,
...
tag_key,
tag_value
FROM aws.cleanrooms.id_mapping_table_tags
...
For permissions required to operate on the <code>id_mapping_table_tags</code> resource, see <a href="/services/cleanrooms/id_mapping_tables/#permissions"><code>id_mapping_tables</code></a>
