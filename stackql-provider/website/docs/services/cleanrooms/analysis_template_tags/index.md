...
Expands all tag keys and values for <code>analysis_templates</code> in a region
...
## `SELECT` examples
Expands tags for all <code>analysis_templates</code> in a region.
```sql
SELECT
region,
arn,
...
For permissions required to operate on the <code>analysis_template_tags</code> resource, see <a href="/services/cleanrooms/analysis_templates/#permissions"><code>analysis_templates</code></a>
