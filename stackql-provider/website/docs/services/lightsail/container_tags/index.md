...
For permissions required to operate on the <code>container_tags</code> resource, see <a href="/services/lightsail/containers/#permissions"><code>containers</code></a>
