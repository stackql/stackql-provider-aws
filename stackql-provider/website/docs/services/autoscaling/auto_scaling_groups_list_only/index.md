...
Lists <code>auto_scaling_groups</code> in a region or regions, for all properties use <a href="/services/serviceName/auto_scaling_groups/"><code>auto_scaling_groups</code></a>
