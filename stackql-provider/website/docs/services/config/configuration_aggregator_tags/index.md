...
For permissions required to operate on the <code>configuration_aggregator_tags</code> resource, see <a href="/services/config/configuration_aggregators/#permissions"><code>configuration_aggregators</code></a>
