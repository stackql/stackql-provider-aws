...
Expands all tag keys and values for <code>certificate_providers</code> in a region
...
## `SELECT` examples
Expands tags for all <code>certificate_providers</code> in a region.
```sql
SELECT
region,
...
For permissions required to operate on the <code>certificate_provider_tags</code> resource, see <a href="/services/iot/certificate_providers/#permissions"><code>certificate_providers</code></a>
