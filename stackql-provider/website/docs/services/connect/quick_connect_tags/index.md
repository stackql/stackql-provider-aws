...
For permissions required to operate on the <code>quick_connect_tags</code> resource, see <a href="/services/connect/quick_connects/#permissions"><code>quick_connects</code></a>
