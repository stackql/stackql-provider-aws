...
For permissions required to operate on the <code>identity_provider_config_tags</code> resource, see <a href="/services/eks/identity_provider_configs/#permissions"><code>identity_provider_configs</code></a>
