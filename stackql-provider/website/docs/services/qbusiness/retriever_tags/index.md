...
Expands all tag keys and values for <code>retrievers</code> in a region
...
## `SELECT` examples
Expands tags for all <code>retrievers</code> in a region.
```sql
SELECT
region,
application_id,
...
For permissions required to operate on the <code>retriever_tags</code> resource, see <a href="/services/qbusiness/retrievers/#permissions"><code>retrievers</code></a>
