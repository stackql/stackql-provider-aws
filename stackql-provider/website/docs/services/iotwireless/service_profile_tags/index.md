...
Expands all tag keys and values for <code>service_profiles</code> in a region
...
## `SELECT` examples
Expands tags for all <code>service_profiles</code> in a region.
```sql
SELECT
region,
name,
...
For permissions required to operate on the <code>service_profile_tags</code> resource, see <a href="/services/iotwireless/service_profiles/#permissions"><code>service_profiles</code></a>
