...
Expands all tag keys and values for <code>decoder_manifests</code> in a region
...
## `SELECT` examples
Expands tags for all <code>decoder_manifests</code> in a region.
```sql
SELECT
region,
arn,
...
For permissions required to operate on the <code>decoder_manifest_tags</code> resource, see <a href="/services/iotfleetwise/decoder_manifests/#permissions"><code>decoder_manifests</code></a>
