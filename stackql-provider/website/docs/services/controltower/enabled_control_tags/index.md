...
Expands all tag keys and values for <code>enabled_controls</code> in a region
...
## `SELECT` examples
Expands tags for all <code>enabled_controls</code> in a region.
```sql
SELECT
region,
control_identifier,
...
For permissions required to operate on the <code>enabled_control_tags</code> resource, see <a href="/services/controltower/enabled_controls/#permissions"><code>enabled_controls</code></a>
