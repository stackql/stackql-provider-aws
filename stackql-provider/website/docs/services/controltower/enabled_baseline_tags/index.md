...
For permissions required to operate on the <code>enabled_baseline_tags</code> resource, see <a href="/services/controltower/enabled_baselines/#permissions"><code>enabled_baselines</code></a>
