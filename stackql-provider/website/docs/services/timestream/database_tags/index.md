...
For permissions required to operate on the <code>database_tags</code> resource, see <a href="/services/timestream/databases/#permissions"><code>databases</code></a>
