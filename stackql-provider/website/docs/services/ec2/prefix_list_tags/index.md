...
Expands all tag keys and values for <code>prefix_lists</code> in a region
...
## `SELECT` examples
Expands tags for all <code>prefix_lists</code> in a region.
```sql
SELECT
region,
prefix_list_name,
...
For permissions required to operate on the <code>prefix_list_tags</code> resource, see <a href="/services/ec2/prefix_lists/#permissions"><code>prefix_lists</code></a>
