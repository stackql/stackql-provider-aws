...
Expands all tag keys and values for <code>network_insights_access_scope_analyses</code> in a region
...
## `SELECT` examples
Expands tags for all <code>network_insights_access_scope_analyses</code> in a region.
```sql
SELECT
region,
...
tag_key,
tag_value
FROM aws.ec2.network_insights_access_scope_analysis_tags
...
For permissions required to operate on the <code>network_insights_access_scope_analysis_tags</code> resource, see <a href="/services/ec2/network_insights_access_scope_analyses/#permissions"><code>network_insights_access_scope_analyses</code></a>
