...
Expands all tag keys and values for <code>verified_access_groups</code> in a region
...
## `SELECT` examples
Expands tags for all <code>verified_access_groups</code> in a region.
```sql
SELECT
region,
...
For permissions required to operate on the <code>verified_access_group_tags</code> resource, see <a href="/services/ec2/verified_access_groups/#permissions"><code>verified_access_groups</code></a>
