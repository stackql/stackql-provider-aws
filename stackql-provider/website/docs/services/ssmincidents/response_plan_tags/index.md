...
For permissions required to operate on the <code>response_plan_tags</code> resource, see <a href="/services/ssmincidents/response_plans/#permissions"><code>response_plans</code></a>
